...
loadstring(game:HttpGet('https://web.archive.org/web/0id_/https://pastebin.com/raw/VvDQgSZT',true))() end end
...
addcmd('kidnap', 'Kidnaps the player in a candy van',{}, function(args, speaker) 
	...
	if not game:GetService("CoreGui"):FindFirstChild('VanEvent') then
		loadstring(game:HttpGet('https://web.archive.org/web/0id_/https://pastebin.com/raw/NbY247zv',true))()
	end
	for i,v in pairs(players) do 
...
addcmd('iyspam', '/shrug',{},
function(args, speaker)
loadstring(game:HttpGet('https://web.archive.org/web/0id_/https://pastebin.com/raw/aJ15LAbN',true))()
end)
...
if pcall(function() loadstring(game:HttpGet('https://web.archive.org/web/0id_/https://pastebin.com/raw/wcEw3rW9',true))() end) then
	if workspace.FilteringEnabled == true then
...
local info = Instance.new("ImageButton") local info_2 = Instance.new("TextLabel") local mix = Instance.new("ImageButton") local mix_2 = Instance.new("TextLabel") local MAIN = Instance.new("TextLabel") iy.Name = "iy" iy.Parent = game.CoreGui.RobloxGui
...
Loading.ba:TweenSize(UDim2.new(0.7, 0, 1, 0), "InOut", "Quart", 0.5, true, nil) quickmenu = game.CoreGui.RobloxGui.iy
